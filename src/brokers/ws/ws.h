...
namespace juiz {
  ...
  public:
    ...
    void* _privateData;
    Request(const std::string& p, const std::string &m, const juiz::Value &b) : path(p), method(m), body(b), _privateData(nullptr), contentType("application/text") {}
  ...
  public:
    ...
    Response(int32_t s, juiz::Value &&body, std::string&& contentType) : version("1.0"), status(s), body(body), contentType(contentType), is_file_(false) {}
    Response(int32_t s, const juiz::Value &body, const std::string& contentType) : version("1.0"), status(s), body(body), contentType(contentType), is_file_(false) {}
